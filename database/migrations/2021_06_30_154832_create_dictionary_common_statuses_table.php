...
class CreateDictionaryCommonStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('dictionary_common_statuses')) {
            Schema::create('dictionary_common_statuses', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('dictionary_common_statuses');
    }
}
