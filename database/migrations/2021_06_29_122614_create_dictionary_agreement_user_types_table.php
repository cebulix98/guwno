...
class CreateDictionaryAgreementUserTypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('dictionary_agreement_user_types')) {
            Schema::create('dictionary_agreement_user_types', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('dictionary_agreement_user_types');
    }
}
