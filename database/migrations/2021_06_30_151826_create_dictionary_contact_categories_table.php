...
class CreateDictionaryContactCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('dictionary_contact_categories')) {
            Schema::create('dictionary_contact_categories', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('dictionary_contact_categories');
    }
}
