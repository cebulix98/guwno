...
class CreateDictionaryPaymentStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('dictionary_payment_statuses')) {
            Schema::create('dictionary_payment_statuses', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('dictionary_payment_statuses');
    }
}
