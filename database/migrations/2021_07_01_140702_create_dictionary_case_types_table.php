...
class CreateDictionaryCaseTypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('dictionary_case_types')) {
            Schema::create('dictionary_case_types', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('dictionary_case_types');
    }
}
