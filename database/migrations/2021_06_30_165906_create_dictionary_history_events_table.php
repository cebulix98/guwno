...
class CreateDictionaryHistoryEventsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('dictionary_history_events')) {
            Schema::create('dictionary_history_events', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('dictionary_history_events');
    }
}
