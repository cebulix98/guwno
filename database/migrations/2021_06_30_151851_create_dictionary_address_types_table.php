...
class CreateDictionaryAddressTypesTable extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('dictionary_address_types')) {
            Schema::create('dictionary_address_types', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('dictionary_address_types');
    }
}
