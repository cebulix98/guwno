...
return [
    ...
    */
    ...
    'between'              => [
        ...
        'file'    => 'Wgrywany plik musi zawierać się w granicach :min - :max kilobajtów.',
    ...
    'gt'                   => [
        ...
        'file'    => 'Wgrywany plik musi być większy niż :value kilobajtów.',
    ...
    'gte'                  => [
        ...
        'file'    => 'Wgrywany plik musi być większy lub równy :value kijobajtów.',
    ...
    'lt'                   => [
        ...
        'file'    => 'Wgrywany plik musi być mniejszy niż :value kijobajtów.',
    ...
    'lte'                  => [
        ...
        'file'    => 'Wgrywany plik musi być mniejszy lub równy :value kijobajtów.',
        'string'  => ':attribute musi być krótszy lub równy :value znaków.',
        'array'   => ':attribute musi mieć :value lub mniej elementów.',
    ],
    'max'                  => [
        'numeric' => ':attribute nie może być większy niż :max.',
        'file'    => 'Wgrywany plik nie może być większy niż :max kilobajtów.',
        'string'  => ':attribute nie może być dłuższy niż :max znaków.',
        'array'   => ':attribute nie może mieć więcej niż :max elementów.',
    ],
    'mimes'                => 'Wgrywany plik musi być plikiem typu :values.',
    'mimetypes'            => 'Wgrywany plik musi być plikiem typu :values.',
    'min'                  => [
        'numeric' => ':attribute musi być nie mniejszy od :min.',
        'file'    => 'Wgrywany plik musi mieć przynajmniej :min kilobajtów.',
    ...
    'size'                 => [
        ...
        'file'    => 'Wgrywany plik musi mieć :size kilobajtów.',
    ...
    |--------------------------------------------------------------------------
    |
    | Here you może specify custom validation messages for attributes using the
    ...
    */
    ...
    'custom' => [
        ...
        'adherence_type_diameter' => [
            'required' => json_encode(['code'=>101, 'field'=>'adherence_type_diameter', 'message'=>'Pole jest wymagane']),
            'numeric' => json_encode(['code'=>102, 'field'=>'adherence_type_diameter', 'message'=>'Pole musi być liczbą']),
        ],
    ],
